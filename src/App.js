...
const App = () => {
  ...
  console.log("TEXT IS ", top_p_text);
    ...
    <div className='screen'>
      ...
      <div id={first_half_layer} className='firsthalf'>
          ...
          <ReactTextTransition
              ...
              noOverflow
          >{top_p_text[0]}</ReactTextTransition>
          <ReactTextTransition
              style={{fontWeight: '1000', fontSize: '60px', marginTop:'10px'}}
              text={top_p_text[1]}
              direction={text_transition_direction}
              springConfig={{ stiffness: 50, damping: 20 }}
              noOverflow
          >{top_p_text[1]}</ReactTextTransition>
          <ReactTextTransition
              ...
              springConfig={{ stiffness: 50, damping: 20 }}
              noOverflow
          >{top_p_text[2]}</ReactTextTransition>
        </div>
        ...
        <div style={{width: '275px', color: 'white', marginLeft: '10%', marginTop: '2vh', height: '280px'}}>
          <ReactTextTransition
              style={{fontWeight: '1000', fontSize: '60px', width:'500px'}}
              text={top_p_text[3]}
              direction={text_transition_direction}
              springConfig={{ stiffness: 50, damping: 20 }}
              noOverflow
          >{top_p_text[3]}</ReactTextTransition>
          <ReactTextTransition
              text={top_p_text[4]}
              direction={text_transition_direction}
              springConfig={{ stiffness: 50, damping: 20 }}
              noOverflow
          >{top_p_text[4]}</ReactTextTransition>
          <ReactTextTransition
              text={top_p_text[5]}
              direction={text_transition_direction}
              springConfig={{ stiffness: 50, damping: 20 }}
              noOverflow
          >{top_p_text[5]}</ReactTextTransition>
          <ReactTextTransition
              text={top_p_text[6]}
              direction={text_transition_direction}
              springConfig={{ stiffness: 50, damping: 20 }}
              noOverflow
          >{top_p_text[6]}</ReactTextTransition>
          </div>
          ...
          <ReactTextTransition
              ...
              springConfig={{ stiffness: 50, damping: 20 }}
              noOverflow
          >{top_p_text[8]}</ReactTextTransition>
        </div>
